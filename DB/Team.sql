...
(
    ...
    TEA_ID int unique not null identity,
...
(
    ...
    Foreign key (CAT_TEA_Id) references TEAM
);
...
(
    ...
    Foreign key (TEA_AWA_TEA_Id) references TEAM
);
...
(
    ...
    Foreign key (TEA_LIN_TEA_Id) references TEAM
);